(function(){
    ...
    */
    ...
    - O desafio é fazer o retorno sem usar "if", "switch" ou operador ternário.
    */
    ...
    */
    function showErrorMessage(operator){
        return 'Operação ' + operator + ' não é permitida!.'
    }
    ...
    */
        if(sum){
            numberOne = 15;
            numberTwo = 35;
            console.log(showOperationMessage(operationSignal, numberOne, numberTwo), sum(numberOne, numberTwo))
        }
        else {
    ...
    */
    ...
    if(subtraction){
        numberOne = 15;
        numberTwo = 35;
        console.log(showOperationMessage(operationSignal, numberOne, numberTwo), subtraction(numberOne, numberTwo))
    }
    else {
        console.log(showErrorMessage(operationSignal));
    }
    ...
    if(multiplication){
        numberOne = 15;
        numberTwo = 35;
        console.log(showOperationMessage(operationSignal, numberOne, numberTwo), multiplication(numberOne, numberTwo))
    }
    else {
        console.log(showErrorMessage(operationSignal));
    }
    ...
    if(division){
        numberOne = 15;
        numberTwo = 35;
        console.log(showOperationMessage(operationSignal, numberOne, numberTwo), division(numberOne, numberTwo))
    }
    else {
        console.log(showErrorMessage(operationSignal));
    }
    ...
    if(mod){
        numberOne = 100;
        numberTwo = 2;
        console.log(showOperationMessage(operationSignal, numberOne, numberTwo), mod(numberOne, numberTwo))
    }
    else {
        console.log(showErrorMessage(operationSignal));
    }
    ...
    */
    operationSignal = 'oláMundo';
    var invalid = calculator(operationSignal);
    if(invalid){
        numberOne = 100;
        numberTwo = 2;
        console.log(showOperationMessage(operationSignal, numberOne, numberTwo), invalid(numberOne, numberTwo))
    }
    else {
        console.log(showErrorMessage(operationSignal));
    }
