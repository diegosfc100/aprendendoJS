(function() {
    ...
    */
    ...
    console.log("<div><section><blockquote>Texto <img /></blockquote></section></div>".match(/(<\w+>)/g, "$1 $2 $3"))
    /*
    ...
    */
    ...
    console.log("<div><ul><li></li><li></li><li><span></span></li></ul></div>".match(/(<\w+>\<\/\w+>)/g, "$1, $2, $3"));
