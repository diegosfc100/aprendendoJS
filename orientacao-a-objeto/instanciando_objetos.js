// Objetos: coleção de pares( chave e valor)
...
const curso = new Object(); // objeto
curso.nome = 'Programação em JavaScript'; // chave: nome ; valor: preco.
curso.preco = 27.99; // valor
console.log(curso);

curso['qtd_alunos'] = 999; // adiionando atributos
console.log(curso);

delete curso['qtd_alunos']; // deletando atributos.
delete curso['preco'];  // deletando atributos
console.log(curso);
...
programa.nome = 'PlayStation OS'; // alterando nome do objeto.
console.log(programa.nome);
console.log(programa);

delete programa.fabricante.filiais; // deletando.
